    ...
    <>
      ...
      <nav className="navbar">
        ...
        <div className="navbar-icons">
          <Link to="/menties/chatbox"><i className="bi bi-chat-left-text icon"></i></Link>
          <Link to="/menties/profile"><i className="bi bi-person-circle icon"></i></Link>
      ...
      {showSidebar && (
        <div className="sidebar">
          <ul>
            <li><Link to="/menties/professionalmentors">Professional Mentors</Link></li>
            <li><Link to="/menties/personalmentors">Personal Mentors</Link></li>
            <li><Link to="/menties/chatbox">Chat Box</Link></li>
            <li><Link to="/menties/profile">Profile</Link></li>
